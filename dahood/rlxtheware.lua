...
local window = library:CreateWindow('TheWare') do
	local folder = window:AddFolder('Main') do
		...
		folder:AddBox({text = "Far Range Aim Height", flag = "aimheightFlag", value = "-0.6", callback = function(a) ballisticsboost = a end})
		folder:AddBox({text = "Close Range Aim Height", flag = "aimHEIGHT2Flag", value = "-0.9", callback = function(b) ballisticsboost2 = b end})
		
		folder:AddBind({text = "Long Range Bind", flag = "farBind", key = "Q", callback = function() end})
		folder:AddBind({text = "Close Range Bind", flag = "closeBind", key = "C", callback = function() end})
